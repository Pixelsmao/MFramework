...
//     }
//
//     public class CustomizedEditorWindow : EditorWindow
//     {
//         private GUIStyle defaultAnimCollapseSectionStyle;
//
//         private readonly Dictionary<string, AnimCollapseSection> sections =
//             new Dictionary<string, AnimCollapseSection>();
//
...
//             GUIStyle labelStyle = GUIStyleLibrary.AlignmentLabelStyle(TextAnchor.MiddleCenter);
//
//             // 计算文本内容的矩形位置
//             Rect textRect = new Rect(Vector2.zero, size); // 使用传入的 size
//
//             // 计算边框的矩形位置，包括填充
//             Rect borderRect = new Rect(textRect.x - borderWidth, textRect.y - borderWidth,
...
//             if (sections.TryGetValue(label, out AnimCollapseSection section)) {
//                 AnimCollapseSection.Show(section, indent);
//             }
//             else {
//                 AnimCollapseSection newSection = new AnimCollapseSection(label, showOnlyInEditorMode, isDefaultExpanded,
//                     drawMethod, editor, color);
//                 AnimCollapseSection.Show(newSection, indent);
//                 sections.Add(label, newSection);
//             }
//         }
//
...
//                 Rect residueRect = new Rect(lastRect.xMax, lastRect.yMin, this.position.width - lastRect.xMax,
...
//             var remainingBuggedEditors = FindObjectsOfType<CustomizedEditorWindow>();
