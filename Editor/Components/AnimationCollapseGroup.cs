...
{
    public class AnimationCollapseGroup
    {
        ...
        private static GUIStyle CreatePaddedStyle(GUIStyle baseStyle, RectOffset padding)
        {
            return new GUIStyle(baseStyle) { padding = padding };
        }
